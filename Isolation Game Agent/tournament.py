...
from game_agent import (MinimaxPlayer, AlphaBetaPlayer, custom_score, opp_diff, opp_diff_defensive,
                        opp_diff_aggressive, opp_diff_decay)
...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=opp_diff), "Opp_Diff"),
        Agent(AlphaBetaPlayer(score_fn=opp_diff_defensive), "OD_Defensive"),
        Agent(AlphaBetaPlayer(score_fn=opp_diff_aggressive), "OD_Aggressive"),
        Agent(AlphaBetaPlayer(score_fn=opp_diff_decay), "OD_Decay")
    ]
